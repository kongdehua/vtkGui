...
// .NAME myChartXY - Factory class for drawing XY charts
//
// .SECTION Description
...
class myChartXYPrivate; // Private class to keep my STL vector in...
class vtkPen;

class VTKCHARTSCORE_EXPORT myChartXY : public vtkAbstractContextItem
{
public:
...
private:
  ...
  myChartXYPrivate *ChartPrivate; // Private class where I hide my STL containers
